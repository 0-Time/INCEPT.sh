...
_INTENT_CATEGORY: dict[str, str] = {
    ...
    "copy_files": "file_ops",
    "move_files": "file_ops",
    "delete_files": "file_ops",
    "change_permissions": "file_ops",
    "change_ownership": "file_ops",
    "create_directory": "file_ops",
    "list_directory": "file_ops",
    "disk_usage": "file_ops",
    "view_file": "file_ops",
    "create_symlink": "file_ops",
    "compare_files": "file_ops",
    "search_text": "text_processing",
    "replace_text": "text_processing",
    "sort_output": "text_processing",
    "count_lines": "text_processing",
    "extract_columns": "text_processing",
    "unique_lines": "text_processing",
    "compress_archive": "archive_ops",
    "extract_archive": "archive_ops",
    "install_package": "package_mgmt",
    "remove_package": "package_mgmt",
    "update_packages": "package_mgmt",
    "search_package": "package_mgmt",
    "start_service": "service_mgmt",
    "stop_service": "service_mgmt",
    "restart_service": "service_mgmt",
    "enable_service": "service_mgmt",
    "service_status": "service_mgmt",
    "create_user": "user_mgmt",
    "delete_user": "user_mgmt",
    "modify_user": "user_mgmt",
    "view_logs": "log_ops",
    "follow_logs": "log_ops",
    "filter_logs": "log_ops",
    "schedule_cron": "scheduling",
    "list_cron": "scheduling",
    "remove_cron": "scheduling",
    "network_info": "networking",
    "test_connectivity": "networking",
    "download_file": "networking",
    "transfer_file": "networking",
    "ssh_connect": "networking",
    "port_check": "networking",
    "process_list": "process_mgmt",
    "kill_process": "process_mgmt",
    "system_info": "process_mgmt",
    "mount_device": "disk_ops",
    "unmount_device": "disk_ops",
}
